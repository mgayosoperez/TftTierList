...
public class Sqlito extends SQLiteOpenHelper{
    ...
    public void mockData(SQLiteDatabase sqLiteDatabase){
        ...
        mockItem(sqLiteDatabase, new Item("Giant Slayer","B.F. Sword","Recurve Bow","The wearers basic attacks deal an additional 9% of the targets Maximum Health as true damage.","B"));
        mockItem(sqLiteDatabase, new Item("Guardian Angel","B.F. Sword","Chain Vest","When the wearer dies, they cleanse negative effects and revive with up to 500 Health after a 2 second delay. This effect can trigger once per combat.","B"));
        ...
        mockItem(sqLiteDatabase, new Item("Zekes Herald","Giants Belt","B.F. Sword","When combat begins, the wearer and all allies within 2 hexes in the same row gain +15% Attack Speed for the rest of combat.","B"));
        ...
        mockItem(sqLiteDatabase, new Item("Hextech Gunblade","B.F. Sword","Needlessly Large Rod","Basic Attacks and spells heal the wearer for 25% of the damage dealt.","C"));
